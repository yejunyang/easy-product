package ai.yunxi.backend.aop;

import ai.yunxi.common.annotation.SystemControllerLog;
import ai.yunxi.common.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(ai.yunxi.common.annotation.SystemControllerLog)")
     ...
     * Service层切点,注解方式
     */
    @Pointcut("@annotation(ai.yunxi.common.annotation.SystemServiceLog)")
    ...
    public void after(JoinPoint joinPoint) {
        try {
            ...
            if (null != username) {
                ...
                //调用线程保存至数据库
                executor.execute(new SaveSystemLogThread(tbLog, systemService));
            }
        } catch (Exception e) {

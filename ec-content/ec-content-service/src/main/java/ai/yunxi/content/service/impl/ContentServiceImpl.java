package ai.yunxi.content.service.impl;
...
import ai.yunxi.core.domain.dto.front.Product;
import ai.yunxi.core.domain.dto.front.ProductDet;
import ai.yunxi.core.domain.entity.*;
import ai.yunxi.core.domain.mapper.TbItemDescMapper;
import ai.yunxi.core.domain.mapper.TbItemMapper;
import ai.yunxi.core.domain.mapper.TbPanelContentMapper;
import ai.yunxi.core.domain.mapper.TbPanelMapper;
...
public class ContentServiceImpl implements ContentService {
    ...
    public ProductDet getProductDet(Long id) {
        ...
        try {
            ...
            if (json != null) {
                ObjectMapper om = new ObjectMapper();
                ProductDet productDet = om.readValue(json, ProductDet.class);
        ...
        try {
            ObjectMapper om = new ObjectMapper();
            jedisClient.set(PRODUCT_ITEM + ":" + id, om.writeValueAsString(productDet));
            //设置过期时间
            jedisClient.expire(PRODUCT_ITEM + ":" + id, ITEM_EXPIRE);
